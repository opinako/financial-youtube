              ...
              <v-container>
                <v-row>
                  <v-col cols="12" md="9" offset-md="1">
                    <v-text-field label="Search" prepend-inner-icon="serch"></v-text-field>
                  </v-col>
                        ...
                        <v-list-item-group>
                          ...
                          <v-list-item>
                            ...
                            <v-list-item-content align="right">
                              ...
                              <v-list-item-subtitle>$200 of 350</v-list-item-subtitle>
                              <v-divider inset></v-divider>
                  ...
                  <v-col cols="12" md="4">
                    <v-card class="mx-auto" max-height="400">
                      <v-img class="white--text align-end" height="150" src="https://picsum.photos/id/1015/200"></v-img>
                ...
                <v-row>
                  <v-col cols="12" md="12">
                    ...
                    <v-list>
                      <v-list-item>
                        <v-list-item-avatar>
                          <v-img src="avatar-2.png"></v-img>
                        </v-list-item-avatar>
                        <v-list-item-content>
                          <v-list-item-title>AAE IdeaPro</v-list-item-title>
                          <v-list-item-subtitle>aaeideapro@gmaol.com</v-list-item-subtitle>
                        </v-list-item-content>
                        <v-list-item-action>
                    ...
                    <v-list>
                      <v-list-item-group>
                        ...
                        <v-list-item>
                          ...
                          <v-list-item-action>
                            <v-icon color="indigo" large>fab fa-cc-mastercard</v-icon>
                          </v-list-item-action>
                        </v-list-item>
  
                        <v-list-item>
                          <v-list-item-avatar color="grey">
                            <v-icon color="black">fas fa-dollar-sign</v-icon>
                          </v-list-item-avatar>
                          <v-list-item-content>
                            <v-list-item-subtitle>
                              Stone River wallet
                      ...
                      <v-col cols="12" md="12">
                        <v-card color="#952175" dark>
                          <div class="d-flex flex-no-wrap justify-space-between">
                            <div>
                              <v-card-title class="headline">Upgrade your plan to GOLD</v-card-title>
                              <v-card-subtitle>With Gold account plan you get access to premium features</v-card-subtitle>
                            </div>
                            <v-avatar class="ma-3" size="100" tile>
                              <v-img src="https://picsum.photos/id/1083/200/300"></v-img>
                            </v-avatar>
                          </div>
                        </v-card>
                      </v-col>
